...
| Data Preprocessing & EDA |  | Load dataset, clean data, encode categorical features, perform basic EDA, prepare train/test data |
| ML Models |  | Implement Random Forest and XGBoost models, train and evaluate them |
