...
- Marda, N., et al. (2024). [[Global Counterfactual Explanations]]
- Guidotti, R. (2025).  [[Survey on Counterfactual Explanations and Recourse]]
- Kavouras, L., et al (2026). [[GLANCE - global actions in a nutshell for counterfactual explainability]]

###### Fairness and Counterfactuals  
- Kusner, M. J., et al. (2017). [[Counterfactual Fairness]]
- Von Kügelgen, J., et al. (2023). [[Fairness of Algorithmic Recourse]]
- Dutta, S., et al. (2025). [[Causal Context in Counterfactual Fairness]]
- Kavouras, L., et al (2023). [[Fairness-Aware Counterfactuals ]]
